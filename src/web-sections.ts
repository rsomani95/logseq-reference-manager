...
// see the Web references table in dev-notes/settings.md before renaming any.
//
...
// keeps its own matching fallback. All three must agree (see dev-notes/settings.md).
