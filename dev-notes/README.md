...
| [`pdf-annotation/`](./pdf-annotation/README.md) | You're working on **PDF annotation import** — the picking rule, the coordinate transform, the `build-import`/Transit write path, the Zotero-DB fallback, or the annotation taxonomy. A whole subfolder; start at its README. |
